...
class ArthamaticOperators
{
    //Undestand the behaviour of the operator...

    static void Main()
    {
        //Arthamatic opertos   + , - , * , / 9:03
        int result = 10 + 20;  // 30 numeric
        Console.WriteLine(result); // 30

        int result1 = 20 - 10;  // 30 numeric
        Console.WriteLine(result1); // 10

        // == , != , < , > , <= , >=  // true or false 
        bool isEqual = 10 == 10;
        Console.WriteLine(isEqual); // true , 10 , "Madan"

        bool isEqual1 = 10 == 20;
        Console.WriteLine(isEqual1); // false , 10 , "Madan"

        bool isEqual2 = 10 < 20;
        Console.WriteLine(isEqual2); // false , 10 , "Madan"

        bool isEqual3 = 10 > 20;
        Console.WriteLine(isEqual3); // false , 10 , "Madan"

        bool isEqual4 = (10 >= 20);
        Console.WriteLine(isEqual4); // false , 10 , "Madan"

        bool isEqual5 = (10 <= 20);
        Console.WriteLine(isEqual5); // false , 10 , "Madan"
